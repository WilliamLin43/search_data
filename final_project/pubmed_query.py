...
handle_0 = Entrez.esearch(db="pubmed", term=str(keyword) + " AND (1990/01/01[Date - Publication] : 2022/1/8[Date - Publication]",
                           ptyp="Review", usehistory="y", retmax=10000)
...
for start in range(0, total, step):
    with open("./dataset1/"+str(keyword)+"_" + str(step*i) +".txt", 'w',encoding="utf-8") as f:
