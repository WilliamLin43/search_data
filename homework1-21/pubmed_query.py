...
handle_0 = Entrez.esearch(db="pubmed", term=str(keyword) + " AND (2021/01/01[Date - Publication] : 2022/10/21[Date - Publication]",
                           ptyp="Review", usehistory="y", retmax=50000)
...
for start in range(0, total, step):
    with open("./Data_PubMed/"+str(keyword)+"_" + str(step*i) +".txt", 'w') as f:
